  ...
  return (
    <SheetPrimitive.Backdrop
      className={cn(
        ...
        "data-[closed]:animate-out data-[open]:animate-in data-[closed]:fade-out-0 data-[open]:fade-in-0",
        className
      )}
      ...
      <SheetPrimitive.Viewport className="fixed inset-0 z-50">
        <SheetPrimitive.Popup
          className={cn(
            ...
            "data-[closed]:animate-out data-[open]:animate-in data-[closed]:duration-300 data-[open]:duration-500",
            side === "right" &&
